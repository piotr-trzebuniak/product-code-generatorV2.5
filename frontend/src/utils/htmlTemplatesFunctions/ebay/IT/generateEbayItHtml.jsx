...
function generateResearchHTML(data) {
  // Sprawdzenie, czy 'data.it' oraz 'data.it.studies' istnieją
  if (!data || !data.IT || !Array.isArray(data.IT.studies)) {
    console.log('Brak danych do wyświetlenia badań');
    return '';  // Zwraca pusty string, gdy brak danych
  }

  const studies = data.IT.studies;
  ...
  const html = `
    <div class="researches__content">
      ${studies
        ...
        <p><strong>Descrizione del:</strong> ${study.description}</p>
...
export const generateEbayItHtml = (productData) => {
  if (
    !productData ||
        ...
        <div class="top-section">
          <div class="container container__top-section">
            ...
            <div class="right-side">
              ...
              ${productData.bulletpoints.it ?
                `<div class="bulletpoints">
                 <div class="roles">
                <h3>Ruolo nell'organismo:</h3>
                ${generateRoleHtml(productData.bulletpoints.it)}
              </div>
                </div>`
              : ''}
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="left-column">
                      <h3>Composizione</h3>
                      <p>Dimensione della confezione: <strong> ${
                        productData.size.sizeAmount
                      } ${productData.size.unit.it} </strong></p>
                      <p>Porzione singola: <strong> ${
                        productData.portion.portionAmount
                      } ${productData.portion.unit.it} </strong></p>
                      <p>
                        Numero di porzioni per confezione: <strong> ${
            ...
            <div id="researches" class="researches section">
              ...
              <div class="researches__heading">
                <img
                  ...
                  alt=""
                />
                <h4 class="section-heading">Ricerca clinica</h4>
                </div>
                    ${researchHTML}
            </div>`
            : ''}
