...
function extractIngredientsAndRemove(htmlString) {
  ...
  if (!match) {
    console.log('Nie znaleziono nagłówka "Ingrédients:" lub składników');
    return {
      extractedText: '',
...
export const generateEbayFrHtmlCosmetics = (productData) => {
  if (
    !productData ||
  ...
  const editedCosmeticsDescription4 = extractIngredientsAndRemove(productData.cosmeticsDescription4.fr)
        ...
        <div class="top-section">
          <div class="container container__top-section">
            ...
            <div class="right-side">
              ...
              <div class="roles">
                ${generateRoleHtml(productData.cosmeticsDescription3.fr)}
              </div>
              </div>
