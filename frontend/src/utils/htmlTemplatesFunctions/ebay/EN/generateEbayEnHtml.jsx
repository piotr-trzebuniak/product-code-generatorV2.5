...
import { removeTrailingBracketAndDots } from "./generateEbayEnHtmlCosmetics";
...
function generateResearchHTML(data) {
  // Sprawdzenie, czy 'data.en' oraz 'data.en.studies' istnieją
  if (!data || !data.EN || !Array.isArray(data.EN.studies)) {
    console.log('Brak danych do wyświetlenia badań');
    return '';  // Zwraca pusty string, gdy brak danych
  }

  const studies = data.EN.studies;
...
export const generateEbayEnHtml = (productData) => {
  if (
    !productData ||
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="left-column">
                      ...
                      } ${productData.size.unit.en} </strong></p>
                      <p>Single serving: <strong> ${
                        productData.portion.portionAmount
                      } ${productData.portion.unit.en} </strong></p>
                      <p>
                        Number of servings per package: <strong> ${
          ...
          ${productData.tableEnd.en}
                  ...
                  <div class="col-md-6">
                    <div class="right-column">
                      ...
                      <p>
                      ${removeTrailingBracketAndDots(productData.contraindications.en)}
                      </p>
                      <h3>Suggested use</h3>
                      <p>${removeTrailingBracketAndDots(productData.howToUse.en)}</p>
                      <h3>Storage</h3>
            ...
            <div id="researches" class="researches section">
              ...
              <div class="researches__heading">
                <img
                  ...
                  alt=""
                />
                <h4 class="section-heading">Clinical research</h4>
                </div>
                    ${researchHTML}
            </div>`
            : ''}
